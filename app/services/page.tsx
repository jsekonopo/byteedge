        ...
        <div className="min-h-screen">
                        ...
                        <div className="relative bg-card border border-border p-8 rounded-3xl shadow-xl">
                            <div className="space-y-4">
                                <div className="flex items-center gap-4 p-4 rounded-xl bg-muted/50 border border-border">
                                    ...
                                    <div>
                                        <div className="text-sm font-semibold text-foreground">Invoice Processor Agent</div>
                                ...
                                <div className="flex items-center gap-4 p-4 rounded-xl bg-muted/50 border border-border opacity-60">
                                    ...
                                    <div>
                                        <div className="text-sm font-semibold text-foreground">Lead Qualifier</div>
                    ...
                    <div className="order-1 md:order-2 space-y-6">
                        ...
                        <ul className="space-y-3">
                            {[
                                ...
                                <li key={i} className="flex items-center gap-3 text-card-foreground font-medium">
            ...
            <Section className="py-24 bg-muted/20">
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="relative">
                        ...
                        <div className="relative bg-card border border-border p-8 rounded-3xl shadow-xl flex items-center justify-center min-h-[300px]">
                            <Code2 className="h-24 w-24 text-muted" />
            ...
            <Section className="py-24 text-center">
                <div className="max-w-3xl mx-auto mb-16 space-y-4">
                    <h2 className="text-3xl font-bold text-foreground">Our Arsenal</h2>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                    {[
                        ...
                        <div key={i} className="p-6 rounded-2xl bg-card border border-border hover:border-primary/30 transition-colors">
                            <div className="font-bold text-lg text-foreground">{tech.title}</div>
                            <div className="text-sm text-muted-foreground">{tech.cat}</div>
                        </div>
                    ))}
                </div>
            </Section>
            ...
            <Section className="py-24">
                <div className="relative rounded-[2.5rem] bg-card border border-border overflow-hidden px-8 py-16 md:px-20 md:py-24 text-center">
                    <div className="absolute inset-0 bg-grid-white/[0.05]"></div>
                    <div className="relative z-10 max-w-2xl mx-auto space-y-8">
                        <h2 className="text-3xl md:text-5xl font-bold text-foreground">Let's build something great.</h2>
